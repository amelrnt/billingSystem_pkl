  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <a type="button" class="btn btn-primary" href="{{url('/formCust')}}">Add new Data</a>
        <br><br>
              ...
              <table class="table table-striped table-advance table-hover">
                <tbody>
                  ...
                  <th><i class="icon_profile"></i> id</th>
                    ...
                    <th><i class="icon_calendar"></i> Phone Number</th>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <a class="btn btn-success" href="{{url('/formCust/'.$c->id)}}"><i class="fas fa-user-edit">Edit</i></a>
                        <a class="btn btn-primary" href="{{url('/formContract/'.$c->id)}}">Add Contract</a>
                      </div>
                    </td>
                  </tr>
                  @endforeach
